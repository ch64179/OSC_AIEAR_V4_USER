...
public class SpringApplicationAdminClient {
	...
	public static final String DEFAULT_OBJECT_NAME = "org.springframework.boot:type=Admin,name=SpringApplication";
	 ...
	 */
	public static JMXConnector connect(String host, int port) throws IOException {
